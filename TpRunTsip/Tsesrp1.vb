...
Namespace TpRunTsip
    ...
    Public Class Tsesrp1
        ...
        ''' <returns></returns>
        Public Shared Function TsEsRp1(tw As TextWriter, tpParm As TpParm, cTableName As String, p As String, q As String, r As String, s As String, t As String, u As String, v As String, w As String, x As String, y As String) As Integer
