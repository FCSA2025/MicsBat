    ...
    Public Class Tsesenv
        ...
        Private Class PrintLinerpenv
            ...
            Public Overrides Sub PageHeader()
                MyBase.PageBefore()
                TpRunTsip.Tsesenv.TsEsEnvPage(Me)
            End Sub
        End Class
        ...
        ''' <returns></returns>
        Public Shared Function TsEsEnv(tw As TextWriter, cTableName As String) As Integer
            ...
            Dim pl As TpRunTsip.Tsesenv.PrintLinerpenv = New TpRunTsip.Tsesenv.PrintLinerpenv()
            pl.OutFile(tw)

            TpRunTsip.Tsesenv.TsEsEnvPage(pl)
            ...
            cBuff = SQLCHARPTR.Format("select tmpinter, tmpcall1, tmpname, tmpoper, tmplatit, tmplongit, tmpgrnd from {0} order by tmpinter desc, tmpcall1", cTableName)
            ...
            While True
                ...
                nCount += 1
                nRet = TpRunTsip.Tsesenv.TsEsEnvDet(pl, interferer, call1, name, oper, latit, longit, grnd)
            End While
        ...
        ''' <returns></returns>
        Private Shared Function TsEsEnvPage(pl As TpRunTsip.Tsesenv.PrintLinerpenv) As Integer
        ...
        Private Shared Function TsEsEnvDet(pl As TpRunTsip.Tsesenv.PrintLinerpenv, interferer As String, call1 As String, name As String, oper As String, latit As Integer, longit As Integer, grnd As Double) As Integer
            Dim cLat As String
            Dim cLatSense As String
            Dim cLong As String
            Dim cLongSense As String

            If Not interferer.Equals(TpRunTsip.Tsesenv.mPrevInt) Then
                TpRunTsip.Tsesenv.mPrevInt = interferer
                pl.Output()
                pl.Output()
                If Not interferer.Equals("I") Then
