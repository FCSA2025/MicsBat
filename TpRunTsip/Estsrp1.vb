...
Namespace TpRunTsip
    ...
    Public Class Estsrp1
        ...
        ''' </summary>
        ''' <paramname="tw"> - the TexWriter object assigned to the .STUDY report.</param>
        ''' <paramname="tpParm"> - TpParm object providing source data.</param>
        ''' <paramname="cTableName"> - unique ID substring of the DB _parm table name.</param>
        ...
        ''' <paramname="txtro"> - see the source code for context.</param>
        ''' <paramname="rxtro"> - see the source code for context.</param>
        ''' <paramname="txpre"> - see the source code for context.</param>
        ''' <paramname="rxpre"> - see the source code for context.</param>
        ''' <paramname="coorddist"> - see the source code for context.</param>
        ''' <returns></returns>
        Public Shared Function EsTsRp1(tw As TextWriter, tpParm As TpParm, cTableName As String, p As String, q As String, r As String, s As String, t As String, u As String, v As String, w As String, x As String, y As String, txtro As Double, rxtro As Double, txpre As Double, rxpre As Double, coorddist As Double) As Integer
            ...
            If tpParm.protype.Equals("T") Then
