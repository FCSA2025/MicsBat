# Documented File: SdUpdateEqpt.cs
**Repository Path:** `SdUpdateEqpt\SdUpdateEqpt.cs`
...
/// <summary>
/// This program updates the Subsidiary Database (SDB) table <b>main.sd_eqpt</b> using field
/// values provided in the prescribed user SDF table su_XXX_eqpt.
/// </summary>
/// <remarks>
/// The command-line usage is:
/// \image html "Usage - SdUpdateEqpt.PNG" ""
/// </remarks>
namespace SdUpdateEqpt
{
    ...
    /// <summary>
    /// This class provides the Main() method for the MICS program SdUpdateEqpt.
    /// </summary>
    public class SdUpdateEqpt
    {
        ...
        /// <summary>
        /// This is the Main() method for the MICS program SdUpdateEqpt.
        /// </summary>
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                // user that executed this program (e.g. 'hulme'). Consequently, hulme.sd_eqpt
                // acts as a surrogate for main.sd_eqpt etc.
                ...
                {
                    Log2.e("\nSdUpdateEqpt.Main(): ERROR: call to Qutils.EnterQueue() failed, rc = " + rc);
                ...
                DynSdbEqpt.SetState(Info.MdbWriteEnabled, Info.SpoofModeIsOff, Info.GlobalSchema);
                ...
                BiUtil.BiBillingRec("UPD_EQPT", infoBuffer);
                ...
                Info.SetDateTimeNow();
                Console.Write("\t\tSDB EQUIPMENT UPDATE REPORT Build {0}\t\tDate: {1} {2}\r\n",
                             Info.BuildMetaData, Info.Date, Info.Time);
                Console.Write("\r\n");
                Console.Write("SDF Name: {0}\r\n", Info.SdfName);

                // Check to see that the associated su_XXX_eqpt table for this
                // SDF base name (XXX) actually exists in the DB.
                if (!Ssutil.UtTableExist(Constant.SU_EQPT, Info.SdfName))
                {
                    Console.Write("\r\n************************************************\r\n");
                    Console.Write("\r\nEquipment sdf {0} does not exist\r\n", Info.SdfName);
                    Console.Write("\r\n************************************************\r\n");
                ...
                Console.Write("SDF Type: Equipment\r\n\r\n");
                ...
                if (rc != Constant.SUCCESS)
                {
                    ...
                    Console.Write("\r\nSdUpdateEqpt: Could not set the database connection to manual commit.\r\n{0}\r\n",
                                    GenUtil.GetUserMess());
                    exitCode = 95;
                    goto cleanUpAndExit;
                }
                ...
                // Perform validation of the prescribed su_XXX_eqpt SDF file even if 
                ...
                // Check for failure of the validation of the prescribed su_XXX_eqpt SDF file.
                ...
                // This method provides the core functionality for SdUpdateEqpt.
                // ============================================================
                rc = Updater.ProcessSuEqpt(hConn, Info.SdfName,
                                                out errCount,
                                                out warnCount,
                                                out recCounts);
                ...
                AtRecordChng.AtRecordChange(Info.DbName, Info.SdfName, Constant.SU_EQPT);
            ...
            {
                Log2.e("\r\r\n\nSdUpdateEqpt.Main(): exception caught: " + e.Message);
                Log2.e("\r\r\n\nSdUpdateEqpt.Main(): stack trace: \r\r\n\n" + e.StackTrace);
                BiUtil.BiBillingRec(Constant.BI_END, "");
                Ssutil.UtDisconnect(1);
        ...
        {
            Console.Write("\r\n");
            Console.Write("\r\n This program updates the Subsidiary Database (SDB) table main.sd_eqpt using field   +");
            Console.Write("\r\n values provided in the prescribed user SDF table [user].su_[sdfName]_eqpt.");
            Console.Write("\r\n");
            Console.Write("\r\n USAGE: SdUpdateEqpt <dbName> <projCode> <sdfName> [-c] [-d] [-p] [-s] [-t]");
            Console.Write("\r\n ===== ");
            Console.Write("\r\n");
            Console.Write("\r\n        dbName           : database name, e.g. 'fcsa'.");
            Console.Write("\r\n        project          : user's project 'charge' code.");
            Console.Write("\r\n        sdfName          : the XXX in user table su_XXX_eqpt.");
            Console.Write("\r\n");
            Console.Write("\r\n        --- For Testing -------------------------------------------------------------");
            ...
            Console.Write("\r\n");
            Console.Write("\r\n e.g.");
            Console.Write("\r\n     SdUpdateEqpt fcsa HULME1_0 test_combo0");
            Console.Write("\r\n");
            Console.Write("\r\n Notes:");
