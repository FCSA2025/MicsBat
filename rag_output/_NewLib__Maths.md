# Documented File: Maths.cs
**Repository Path:** `_NewLib\Maths.cs`
...
{
    /// <summary>
    /// Provides methods that supplement the standard
    /// system math library, e.g. providing trigonometric functions
    /// based on degrees rather than radians, etc.
    /// </summary>
    public class Maths
    {
        ...
        /// <summary>
        /// This method returns the inverse cosine, in degrees,
        ...
        {
            return Math.Acos(d) * RAD_TO_DEG;
        }

        /// <summary>
        /// This method returns the inverse sine, in degrees,
        /// of a prescribed value.
        /// </summary>
        /// <param name="d"></param>
        /// <returns></returns>
        ...
        {
            return Math.Asin(d) * RAD_TO_DEG;
        }

        /// <summary>
        /// This method returns the inverse tangent, in degrees,
        /// of a prescribed value.
        /// </summary>
        /// <param name="d"></param>
        /// <returns></returns>
        ...
        {
            return Math.Atan(d) * RAD_TO_DEG;
        }

        /// <summary>
        /// This method returns the angle, in degrees, subtended with
        /// the X-axis of a prescribed point (x, y) in a Euclidean space.
        /// </summary>
        /// <remarks>
        /// Note: Atan2d(eastX, northX) returns the bearing relative to North.
        /// </remarks>
        /// <param name="y"></param>
        /// <param name="x"></param>
        /// <returns></returns>
        public static double Atan2D(double y, double x)  // Stet.
        {
            return Math.Atan2(y, x) * RAD_TO_DEG;
        }

        /// <summary>
        /// This method returns the cosine of a prescribed number of degrees.
        /// </summary>
        /// <param name="d"></param>
        /// <returns></returns>
        public static double CosD(double d)
        {
            return Math.Cos(d * DEG_TO_RAD);
        }

        /// <summary>
        /// This method returns the sine of a prescribed number of degrees.
        /// </summary>
        /// <param name="d"></param>
        /// <returns></returns>
        public static double SinD(double d)
        {
            return Math.Sin(d * DEG_TO_RAD);
        }

        /// <summary>
        /// This method returns the tangent of a prescribed number of degrees.
        /// </summary>
        /// <param name="d"></param>
        /// <returns></returns>
        public static double TanD(double d)
        {
            return Math.Tan(d * DEG_TO_RAD);
        }

        /// <summary>
        /// This method returns true if a prescribed integer value lies
        /// between prescribed lower and upper integer values (inclusive).
        /// </summary>
        /// <param name="lower"></param>
        /// <param name="upper"></param>
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool InRange(int lower, int upper, int value)
        {
            bool inRange = false;
        ...
        /// <summary>
        /// This method returns true if a prescribed integer value lies
        /// between prescribed lower and upper floating-point values (inclusive).
        /// </summary>
        /// <param name="lower"></param>
        /// <param name="upper"></param>
        /// <param name="value"></param>
        /// <returns></returns>
        public static bool InRange(double lower, double upper, double value)
        {
            bool inRange = false;
        ...
        /// <summary>
        /// This method returns true if the absolute difference between
        /// two prescribed values is strictly less than a prescribed tolerance.
        /// </summary>
        /// <param name="x"></param>
        /// <param name="y"></param>
        /// <param name="tolerance"></param>
        /// <returns></returns>
        public static bool Near(double x, double y, double tolerance)
        {
            return Math.Abs(x - y) < Math.Abs(tolerance);
        }

        /// <summary>
        /// This method returns the value of the Q-function for a prescribed value of x; 
        /// Q(x) is the tail distribution function of the standard normal Gauusian distribution; 
        /// in other words, Q(x) is the probability that a normal (Gaussian) random variable 
        /// has a value larger than x standard deviations; Q(x) is calculated using its close
        /// relationship with the Erfc(c) function.
        /// </summary>
        /// <param name="x"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// This method returns the inverse value of the Q-function for a prescribed value of y; 
        /// ie if y = Q(x) then x = InvQ(y) is the returned value; the calculation uses InvErfc().
        /// </summary>
        /// <param name="y"></param>
        /// <returns></returns>
        public static double InvQ(double y)
        {
            return Math.Sqrt(2.0) * InvErfc(2 * y);
        }
        ...
        /// <summary>
        /// Returns the value of the inverse of the complementary error function; 
        /// if y = Erfc(x) then this method returns the value x.
        /// </summary>
        public static double InvErfc(double y)
        {
            // Assume that erfcTest is in the range (0, 1].
            double xLower = 0;
            double xUpper = 10.0;
            double delta = 0.5 * (xUpper - xLower);
            double xMiddle = xLower + delta;
            double erfcMiddle;
            const double MIN_DELTA = 1.0E-7;

            while (delta > MIN_DELTA)
            {
                xMiddle = xLower + delta;
                erfcMiddle = Erfc(xMiddle);
                ...
                //Console.Write("\nxLower = {0}, xUpper = {1}, erfcMiddle = {2}, xMiddle = {3}", xLower, xUpper, erfcMiddle, xMiddle);
            }
