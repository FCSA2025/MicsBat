...
**Repository Path:** `SdUpdateBand\Validation.cs`
...
namespace SdUpdateBand
{
    ...
    /// SDB table su_XXX_band; this is achieved by running the existing
    ...
    {
        /// <summary>
        /// This method performs the validation of a prescribed user SDB table su_XXX_band; 
        ...
        public static int Perform(out UserTables userTables, out SQLLEN[] userTablesNullInds)
        {
            ...
            else
            {
                ...
                int tabletype = Constant.SU_BAND;
