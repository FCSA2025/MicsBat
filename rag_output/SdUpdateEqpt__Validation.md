...
**Repository Path:** `SdUpdateEqpt\Validation.cs`
...
namespace SdUpdateEqpt
{
    ...
    /// SDB table su_XXX_eqpt; this is achieved by running the existing
    ...
    {
        /// <summary>
        /// This method performs the validation of a prescribed user SDB table su_XXX_eqpt; 
        ...
        public static int Perform(bool isValidIfAlreadyPosted, out UserTables userTables, out SQLLEN[] userTablesNullInds)
        {
            ...
            else
            {
                ...
                int tabletype = Constant.SU_EQPT;
