# Documented File: SdUpdateNote.cs
**Repository Path:** `SdUpdateNote\SdUpdateNote.cs`
...
/// <summary>
/// This program updates the Subsidiary Database (SDB) table <b>main.sd_note</b> using field
/// values provided in the prescribed user SDF table su_XXX_note.
/// </summary>
/// <remarks>
/// The command-line usage is:
/// \image html "Usage - SdUpdateNote.PNG" ""
/// </remarks>
namespace SdUpdateNote
{
    ...
    /// <summary>
    /// This class provides the Main() method for the MICS program SdUpdateNote.
    /// </summary>
    public class SdUpdateNote
    {
        ...
        /// <summary>
        /// This is the Main() method for the MICS program SdUpdateNote.
        /// </summary>
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                // user that executed this program (e.g. 'hulme'). Consequently, hulme.sd_note
                // acts as a surrogate for main.sd_note etc.
                ...
                {
                    Log2.e("\nSdUpdateNote.Main(): ERROR: call to Qutils.EnterQueue() failed, rc = " + rc);
                ...
                DynSdbNote.SetState(Info.MdbWriteEnabled, Info.SpoofModeIsOff, Info.GlobalSchema);
                ...
                BiUtil.BiBillingRec("UPD_NOTE", infoBuffer);
                ...
                Info.SetDateTimeNow();
                Console.Write("\t\tSDB NOTE UPDATE REPORT Build {0}\t\tDate: {1} {2}\r\n",
                             Info.BuildMetaData, Info.Date, Info.Time);
                Console.Write("\r\n");
                Console.Write("SDF Name: {0}\r\n", Info.SdfName);

                // Check to see that the associated su_XXX_note table for this
                // SDF base name (XXX) actually exists in the DB.
                if (!Ssutil.UtTableExist(Constant.SU_NOTE, Info.SdfName))
                {
                    Console.Write("\r\n************************************************\r\n");
                    Console.Write("\r\nNote sdf {0} does not exist\r\n", Info.SdfName);
                    Console.Write("\r\n************************************************\r\n");
                ...
                if (rc != Constant.SUCCESS)
                {
                    ...
                    Console.Write("\r\nSdUpdateNote: Could not set the database connection to manual commit.\r\n{0}\r\n",
                                    GenUtil.GetUserMess());
                    exitCode = 95;
                    goto cleanUpAndExit;
                }
                ...
                // Perform validation of the prescribed su_XXX_note SDF file even if 
                ...
                // Check for failure of the validation of the prescribed su_XXX_note SDF file.
                ...
                // This method provides the core functionality for SdUpdateNote.
                // ============================================================
                rc = Updater.ProcessSuNote(hConn, Info.SdfName,
                                                out errCount,
                                                out warnCount,
                                                out recCounts);
                ...
                AtRecordChng.AtRecordChange(Info.DbName, Info.SdfName, Constant.SU_NOTE);
            ...
            {
                Log2.e("\r\r\n\nSdUpdateNote.Main(): exception caught: " + e.Message);
                Log2.e("\r\r\n\nSdUpdateNote.Main(): stack trace: \r\r\n\n" + e.StackTrace);
                BiUtil.BiBillingRec(Constant.BI_END, "");
                Ssutil.UtDisconnect(1);
        ...
        {
            Console.Write("\r\n");
            Console.Write("\r\n This program updates the Subsidiary Database (SDB) table main.sd_note using field   +");
            Console.Write("\r\n values provided in the prescribed user SDF table [user].su_[sdfName]_note.");
            Console.Write("\r\n");
            Console.Write("\r\n USAGE: SdUpdateNote <dbName> <projCode> <sdfName> [-c] [-d] [-p] [-s] [-t]");
            Console.Write("\r\n ===== ");
            Console.Write("\r\n");
            Console.Write("\r\n        dbName           : database name, e.g. 'fcsa'.");
            Console.Write("\r\n        project          : user's project 'charge' code.");
            Console.Write("\r\n        sdfName          : the XXX in user table su_XXX_note.");
            Console.Write("\r\n");
            Console.Write("\r\n        --- For Testing -------------------------------------------------------------");
            ...
            Console.Write("\r\n");
            Console.Write("\r\n e.g.");
            Console.Write("\r\n     SdUpdateNote fcsa HULME1_0 test_combo0");
            Console.Write("\r\n");
            Console.Write("\r\n Notes:");
