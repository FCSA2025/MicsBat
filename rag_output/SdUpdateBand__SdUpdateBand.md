# Documented File: SdUpdateBand.cs
**Repository Path:** `SdUpdateBand\SdUpdateBand.cs`
**Primary Layer:** `SdUpdateBand`
...
/// <summary>
/// This program updates the Subsidiary Database (SDB) table <b>main.sd_band</b> using field
/// values provided in the prescribed user SDF table su_XXX_band.
/// </summary>
/// <remarks>
/// The command-line usage is:
/// \image html "Usage - SdUpdateBand.PNG" ""
/// </remarks>
namespace SdUpdateBand
{
    ...
    /// <summary>
    /// This class provides the Main() method for the MICS program SdUpdateBand.
    /// </summary>
    public class SdUpdateBand
    {
        private static bool mIsCreateSpoofTables = false;
        private static bool mIsWriteSpoofTestData = false;

        /// <summary>
        /// This is the Main() method for the MICS program SdUpdateBand.
        /// </summary>
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                // user that executed this program (e.g. 'hulme'). Consequently, hulme.sd_band
                // acts as a surrogate for main.sd_band etc.
                ...
                DynSdbBand.SetState(Info.MdbWriteEnabled, Info.SpoofModeIsOff, Info.GlobalSchema);
                ...
                BiUtil.BiBillingRec("UPD_BAND", infoBuffer);
                ...
                Info.SetDateTimeNow();
                Console.Write("\t\tSDB BAND UPDATE REPORT Build {0}\t\tDate: {1} {2}\r\n",
                             Info.BuildMetaData, Info.Date, Info.Time);
                Console.Write("\r\n");
                Console.Write("SDF Name: {0}\r\n", Info.SdfName);

                // Check to see that the associated su_XXX_band table for this
                // SDF base name (XXX) actually exists in the DB.
                if (!Ssutil.UtTableExist(Constant.SU_BAND, Info.SdfName))
                {
                    Console.Write("\r\n************************************************\r\n");
                    Console.Write("\r\nBand sdf {0} does not exist\r\n", Info.SdfName);
                    Console.Write("\r\n************************************************\r\n");
                ...
                if (rc != Constant.SUCCESS)
                {
                    ...
                    Console.Write("\r\nsdUpdateBand: Could not set the database connection to manual commit.\r\n{0}\r\n",
                                    GenUtil.GetUserMess());
                    exitCode = 95;
                    goto cleanUpAndExit;
                }
                ...
                // Perform validation of the prescribed su_XXX_band SDF file even if 
                ...
                // Check for failure of the validation of the prescribed su_XXX_band SDF file.
                ...
                // This method provides the core functionality for SdUpdateBand.
                // ============================================================
                rc = Updater.ProcessSuBand(hConn, Info.SdfName,
                                                out errCount,
                                                out warnCount,
                                                out recCounts);
                ...
                AtRecordChng.AtRecordChange(Info.DbName, Info.SdfName, Constant.SU_BAND);
            ...
            {
                Log2.e("\r\r\n\nSdUpdateBand.Main(): exception caught: " + e.Message);
                Log2.e("\r\r\n\nSdUpdateBand.Main(): stack trace: \r\r\n\n" + e.StackTrace);
                BiUtil.BiBillingRec(Constant.BI_END, "");
                Ssutil.UtDisconnect(1);
        ...
        {
            Console.Write("\r\n");
            Console.Write("\r\n This program updates the Subsidiary Database (SDB) table main.sd_band using field   +");
            Console.Write("\r\n values provided in the prescribed user SDF table [user].su_[sdfName]_band.");
            Console.Write("\r\n");
            Console.Write("\r\n USAGE: SdUpdateBand <dbName> <projCode> <sdfName> [-c] [-d] [-s] [-t]");
            Console.Write("\r\n ===== ");
            Console.Write("\r\n");
            Console.Write("\r\n        dbName           : database name, e.g. 'fcsa'.");
            Console.Write("\r\n        project          : user's project 'charge' code.");
            Console.Write("\r\n        sdfName          : the XXX in user table su_XXX_band.");
            Console.Write("\r\n");
            Console.Write("\r\n        --- For Testing -------------------------------------------------------------");
            ...
            Console.Write("\r\n");
            Console.Write("\r\n e.g.");
            Console.Write("\r\n     SdUpdateBand fcsa HULME1_0 test_combo0");
            Console.Write("\r\n");
            Console.Write("\r\n Notes:");
