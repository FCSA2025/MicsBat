# Documented File: BetterFolderBrowser.cs
**Repository Path:** `SendLAMLreports\BetterFolderBrowser.cs`
...
namespace SendLAMLreports
{
    ...
    public partial class BetterFolderBrowser : CommonDialog
    {
        ...
        private BetterFolderBrowserDialog _dialog = new BetterFolderBrowserDialog();
