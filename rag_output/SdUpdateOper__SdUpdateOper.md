# Documented File: SdUpdateOper.cs
**Repository Path:** `SdUpdateOper\SdUpdateOper.cs`
...
/// <summary>
/// This program updates the Subsidiary Database (SDB) table <b>main.sd_oper</b> using field
/// values provided in the prescribed user SDF table su_XXX_oper.
/// </summary>
/// <remarks>
/// The command-line usage is:
/// \image html "Usage - SdUpdateOper.PNG" ""
/// </remarks>
namespace SdUpdateOper
{
    ...
    /// <summary>
    /// This class provides the Main() method for the MICS program SdUpdateOper.
    /// </summary>
    public class SdUpdateOper
    {
        ...
        /// <summary>
        /// This is the Main() method for the MICS program SdUpdateOper.
        /// </summary>
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                // user that executed this program (e.g. 'hulme'). Consequently, hulme.sd_oper
                // acts as a surrogate for main.sd_oper etc.
                ...
                {
                    Log2.e("\nSdUpdateOper.Main(): ERROR: call to Qutils.EnterQueue() failed, rc = " + rc);
                ...
                BiUtil.BiBillingRec("UPD_OPER", infoBuffer);
                ...
                // Check to see that the associated su_XXX_oper table for this
                // SDF base name (XXX) actually exists in the DB.
                if (!Ssutil.UtTableExist(Constant.SU_OPER, Info.SdfName))
                {
                    Console.Write("\r\n************************************************\r\n");
                    Console.Write("\r\nOperator sdf {0} does not exist\r\n", Info.SdfName);
                    Console.Write("\r\n************************************************\r\n");
                ...
                Console.Write("SDF Type: Operator\r\n\r\n");
                ...
                if (rc != Constant.SUCCESS)
                {
                    ...
                    Console.Write("\r\nSdUpdateOper: Could not set the database connection to manual commit.\r\n{0}\r\n",
                                    GenUtil.GetUserMess());
                    exitCode = 95;
                    goto cleanUpAndExit;
                }
                ...
                // Perform validation of the prescribed su_XXX_oper SDF file even if 
                ...
                // Check for failure of the validation of the prescribed su_XXX_oper SDF file.
                ...
                // This method provides the core functionality for SdUpdateOper.
                // ============================================================
                rc = Updater.ProcessSuOper(hConn, Info.SdfName,
                                                out errCount,
                                                out warnCount,
                                                out recCounts);
                ...
                AtRecordChng.AtRecordChange(Info.DbName, Info.SdfName, Constant.SU_OPER);
            ...
            {
                Log2.e("\r\r\n\nSdUpdateOper.Main(): exception caught: " + e.Message);
                Log2.e("\r\r\n\nSdUpdateOper.Main(): stack trace: \r\r\n\n" + e.StackTrace);
                BiUtil.BiBillingRec(Constant.BI_END, "");
                Ssutil.UtDisconnect(1);
        ...
        {
            Console.Write("\r\n");
            Console.Write("\r\n This program updates the Subsidiary Database (SDB) table main.sd_oper using field   +");
            Console.Write("\r\n values provided in the prescribed user SDF table [user].su_[sdfName]_oper.");
            Console.Write("\r\n");
            Console.Write("\r\n USAGE: SdUpdateOper <dbName> <projCode> <sdfName> [-c] [-d] [-p] [-s] [-t]");
            Console.Write("\r\n ===== ");
            Console.Write("\r\n");
            Console.Write("\r\n        dbName           : database name, e.g. 'fcsa'.");
            Console.Write("\r\n        project          : user's project 'charge' code.");
            Console.Write("\r\n        sdfName          : the XXX in user table su_XXX_oper.");
            Console.Write("\r\n");
            Console.Write("\r\n        --- For Testing -------------------------------------------------------------");
            ...
            Console.Write("\r\n");
            Console.Write("\r\n e.g.");
            Console.Write("\r\n     SdUpdateOper fcsa HULME1_0 test_combo0");
            Console.Write("\r\n");
            Console.Write("\r\n Notes:");
