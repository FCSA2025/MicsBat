...
**Repository Path:** `TpRunTsip 20231124\Tstsrp2.cs`
...
namespace TpRunTsip
{
    ...
    public class Tstsrp2
    {
        ...
        public static int TsTsRp2(TextWriter tw, string cTableName)
        {
            ...
            cBuff = String.Format("select tmpinter, tmpcall1, tmpname, tmpoper, tmplatit, tmplongit, tmpgrnd from {0} order by tmpinter desc, tmpcall1 ", cTableName);
