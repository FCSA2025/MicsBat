...
**Repository Path:** `SdUpdateAnte\Validation.cs`
...
namespace SdUpdateAnte
{
    ...
    /// <summary>
    /// This class provides the method that performs validation of prescribed user
    /// SDB tables su_XXX_ante and su_XXX_antd; this is achieved by running the existing
    ...
    {
        /// <summary>
        /// This method performs the validation of prescribed user
        /// SDB tables su_XXX_ante and su_XXX_antd; this is achieved by running the existing
        /// WebMICS program 'sdfValidate.exe' with the appropriate command line arguments
        /// in a separate process.
        /// </summary>
        ...
        /// <returns></returns>
        public static int Perform(out UserTables userTables, out SQLLEN[] userTablesNullInds)
        {
            // 'out' requirement.
            userTables = null;
            ...
            else
            {
                ...
                int tabletype = Constant.SU_ANTE;
                ...
                else
                {
                    ...
                    else if (userTables.validstat.ToUpper() != "Y")
                    {
                        // validstatis is not "Y".
                        Log2.e("\n\nValidation.Perform(): ERROR: user_tables record is FOUND but validstat is not \"Y\".");
                        Console.Write("\r\n\t\tSDF failed validation.\r\n");
                        status = 1;
                    }
                    else
                    {
                        ...
                        //...Log2.v("\nValidation.Perform(): user_tables record FOUND: validation SUCCEEDED");
