...
**Repository Path:** `SdUpdateTowr\Validation.cs`
...
namespace SdUpdateTowr
{
    ...
    /// SDB table su_XXX_towr; this is achieved by running the existing
    ...
    {
        /// <summary>
        /// This method performs the validation of a prescribed user SDB table su_XXX_towr; 
        ...
        public static int Perform(bool isValidIfAlreadyPosted, out UserTables userTables, out SQLLEN[] userTablesNullInds)
        {
            ...
            else
            {
                ...
                int tabletype = Constant.SU_TOWR;
