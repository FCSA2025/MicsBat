...
**Repository Path:** `SdUpdateRout\Validation.cs`
...
namespace SdUpdateRout
{
    ...
    /// SDB table su_XXX_rout; this is achieved by running the existing
    ...
    {
        /// <summary>
        /// This method performs the validation of a prescribed user SDB table su_XXX_rout; 
        ...
        public static int Perform(bool isValidIfAlreadyPosted, out UserTables userTables, out SQLLEN[] userTablesNullInds)
        {
            ...
            else
            {
                ...
                int tabletype = Constant.SU_ROUT;
