...
**Repository Path:** `SdUpdateTraf\Validation.cs`
...
namespace SdUpdateTraf
{
    ...
    /// SDB table su_XXX_traf; this is achieved by running the existing
    ...
    {
        /// <summary>
        /// This method performs the validation of a prescribed user SDB table su_XXX_traf; 
        ...
        public static int Perform(bool isValidIfAlreadyPosted, out UserTables userTables, out SQLLEN[] userTablesNullInds)
        {
            ...
            else
            {
                ...
                int tabletype = Constant.SU_TRAF;
