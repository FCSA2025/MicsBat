...
**Repository Path:** `TpRunTsip\TpRunTsip.cs`
...
using System.Data.SqlClient;// necessary for bulk copy
...
namespace TpRunTsip
{
    ...
    public class TpRunTsip
    {
        ...
        /* table names for storing TSIP results in database */
        private static string tblAGGINTREP = null;
        private static string tblCASESUM = null;
        private static string tblEXEC = null;
        private static string tblHILO = null;
        private static string tblSTATSUM = null;

        /* ODBC database connection string */
        private static string cnstr = "DSN=remicsdev;DATABASE=remicsdev;Trusted_Connection=yes";
        private static OdbcConnection connection = new OdbcConnection(cnstr);
        ...
        private static void OpenReportStreams(string tableName, string runname, string protype)
        {
            ...
            if (TsipReportHelper.OutputToFiles)
            {
                ...
                tblCASESUM = "venn.tsipCASESUMStore";
                tblEXEC = "venn.tsipEXECStore";
                tblHILO = "venn.tsipHILOStore";
                tblSTATSUM = "venn.tsipSTATSUMStore";

                //Console.WriteLine("\n\nTpRunTsip.OpenReportStreams()3:\n");

                /* create DataTables for storing TSIP results in database */
                // open connection
                //connection.Open();

                string strSql = "SELECT * FROM venn.tsipAGGINTREPStoredef WHERE 1 = 2";
                DataTable oDTAGGINTREP = new DataTable();
                OdbcDataAdapter Da1 = new OdbcDataAdapter();
                Console.WriteLine("\n\nTpRunTsip.OpenReportStreams()3a:\n");
                try
                {
                    Da1.SelectCommand = new OdbcCommand(strSql, connection);
                    Da1.Fill(oDTAGGINTREP);
                }
                catch (Exception e)
                {
                ...
                Console.WriteLine("\n\nTpRunTsip.OpenReportStreams()3b:\n");

                //Console.WriteLine("\n\nTpRunTsip.OpenReportStreams()4:\n");
