# Documented File: SdUpdateRout.cs
**Repository Path:** `SdUpdateRout\SdUpdateRout.cs`
...
/// <summary>
/// This program updates the Subsidiary Database (SDB) table <b>main.sd_rout</b> using field
/// values provided in the prescribed user SDF table su_XXX_rout.
/// </summary>
/// <remarks>
/// The command-line usage is:
/// \image html "Usage - SdUpdateRout.PNG" ""
/// </remarks>
namespace SdUpdateRout
{
    ...
    /// <summary>
    /// This class provides the Main() method for the MICS program SdUpdateRout.
    /// </summary>
    public class SdUpdateRout
    {
        ...
        /// <summary>
        /// This is the Main() method for the MICS program SdUpdateRout.
        /// </summary>
        ...
        static void Main(string[] args)
        {
            try
            {
...
#if false
                string mLog2FilePath = @"d:\MicsBatchLogs\SdUpdateRout.log";
                ...
                // user that executed this program (e.g. 'hulme'). Consequently, hulme.sd_rout
                // acts as a surrogate for main.sd_rout etc.
                ...
                {
                    Log2.e("\nSdUpdateRout.Main(): ERROR: call to Qutils.EnterQueue() failed, rc = " + rc);
                ...
                BiUtil.BiBillingRec("UPD_ROUT", infoBuffer);
                ...
                Info.SetDateTimeNow();
                Console.Write("\t\tSDB OPERATOR UPDATE REPORT Build {0}\t\tDate: {1} {2}\r\n",
                             Info.BuildMetaData, Info.Date, Info.Time);
                Console.Write("\r\n");
                Console.Write("SDF Name: {0}\r\n", Info.SdfName);

                // Check to see that the associated su_XXX_rout table for this
                // SDF base name (XXX) actually exists in the DB.
                if (!Ssutil.UtTableExist(Constant.SU_ROUT, Info.SdfName))
                {
                    Console.Write("\r\n************************************************\r\n");
                    Console.Write("\r\nRout sdf {0} does not exist\r\n", Info.SdfName);
                    Console.Write("\r\n************************************************\r\n");
                ...
                if (rc != Constant.SUCCESS)
                {
                    ...
                    Console.Write("\r\nSdUpdateRout: Could not set the database connection to manual commit.\r\n{0}\r\n",
                                    GenUtil.GetUserMess());
                    exitCode = 95;
                    goto cleanUpAndExit;
                }
                ...
                // Perform validation of the prescribed su_XXX_rout SDF file even if 
                ...
                // Check for failure of the validation of the prescribed su_XXX_rout SDF file.
                ...
                // This method provides the core functionality for SdUpdateRout.
                // ============================================================
                rc = Updater.ProcessSuRout(hConn, Info.SdfName,
                                                out errCount,
                                                out warnCount,
                                                out recCounts);
                ...
                AtRecordChng.AtRecordChange(Info.DbName, Info.SdfName, Constant.SU_ROUT);
            ...
            {
                Log2.e("\r\r\n\nSdUpdateRout.Main(): exception caught: " + e.Message);
                Log2.e("\r\r\n\nSdUpdateRout.Main(): stack trace: \r\r\n\n" + e.StackTrace);
                BiUtil.BiBillingRec(Constant.BI_END, "");
                Ssutil.UtDisconnect(1);
        ...
        {
            Console.Write("\r\n");
            Console.Write("\r\n This program updates the Subsidiary Database (SDB) table main.sd_rout using field   +");
            Console.Write("\r\n values provided in the prescribed user SDF table [user].su_[sdfName]_rout.");
            Console.Write("\r\n");
            Console.Write("\r\n USAGE: SdUpdateRout <dbName> <projCode> <sdfName> [-c] [-d] [-p] [-s] [-t]");
            Console.Write("\r\n ===== ");
            Console.Write("\r\n");
            Console.Write("\r\n        dbName           : database name, e.g. 'fcsa'.");
            Console.Write("\r\n        project          : user's project 'charge' code.");
            Console.Write("\r\n        sdfName          : the XXX in user table su_XXX_rout.");
            Console.Write("\r\n");
            Console.Write("\r\n        --- For Testing -------------------------------------------------------------");
            ...
            Console.Write("\r\n");
            Console.Write("\r\n e.g.");
            Console.Write("\r\n     SdUpdateRout fcsa HULME1_0 test_combo0");
            Console.Write("\r\n");
            Console.Write("\r\n Notes:");
