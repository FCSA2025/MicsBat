...
**Repository Path:** `SdUpdatePlan\Validation.cs`
...
namespace SdUpdatePlan
{
    ...
    /// SDB tables su_XXX_plan and su_XXX_plnd; this is achieved by running the existing
    ...
    public class Validation
    {
        ...
        public static int Perform(bool isValidIfAlreadyPosted, out UserTables userTables, out SQLLEN[] userTablesNullInds)
        {
            ...
            // a file whose path is TEMP_DIR + Info.SdfName + ".txt"  .
            ...
            else
            {
                ...
                int tabletype = Constant.SU_PLAN;
                ...
                else
                {
                    ...
                    else if (validstat == "P" && isValidIfAlreadyPosted)
                    {
                        ...
                        // The legacy C/C++ version of SdUpdatePlan fails validation in this scenario.
