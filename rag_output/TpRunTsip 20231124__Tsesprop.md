# Documented File: Tsesprop.cs
**Repository Path:** `TpRunTsip 20231124\Tsesprop.cs`
...
namespace TpRunTsip
{
    ...
    public class Tsesprop
    {
        ...
        /// <returns></returns>
        public static int TsEsProp(TextWriter tw, string cTableName)
        {
            ...
            PrintLinerp2 p = new PrintLinerp2();
            p.OutFile(tw);
            ...
            cBuff = String.Format("select tmpinter, tmpcall1, tmpname, tmpoper, tmplatit, tmplongit, tmpgrnd from {0} order by tmpinter, tmpcall1",
                                    cTableName);
            ...
            while (true)
            {
                ...
                nRet = TsEsPropDet(p, interferer, call1, name, oper, latit, longit, grnd);
            }
        ...
        /// <returns></returns>
        private static int TsEsPropPage(PrintLinerp2 pl)
        {
            string cCurrDate;
            string cCurrTime;
        ...
        /// <returns></returns>
        private static int TsEsPropDet(PrintLinerp2 pl,
                                string interferer,
                                string call1,
                                string name,
                                string oper,
