...
**Repository Path:** `SdUpdateOper\Validation.cs`
...
namespace SdUpdateOper
{
    ...
    /// SDB table su_XXX_oper; this is achieved by running the existing
    ...
    {
        /// <summary>
        /// This method performs the validation of a prescribed user SDB table su_XXX_oper; 
        ...
        public static int Perform(bool isValidIfAlreadyPosted, out UserTables userTables, out SQLLEN[] userTablesNullInds)
        {
            ...
            else
            {
                ...
                int tabletype = Constant.SU_OPER;
