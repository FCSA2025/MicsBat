...
**Repository Path:** `SdUpdateTown\Validation.cs`
...
namespace SdUpdateTown
{
    ...
    /// SDB table su_XXX_town; this is achieved by running the existing
    ...
    {
        /// <summary>
        /// This method performs the validation of a prescribed user SDB table su_XXX_town; 
        ...
        public static int Perform(bool isValidIfAlreadyPosted, out UserTables userTables, out SQLLEN[] userTablesNullInds)
        {
            ...
            else
            {
                ...
                int tabletype = Constant.SU_TOWN;
