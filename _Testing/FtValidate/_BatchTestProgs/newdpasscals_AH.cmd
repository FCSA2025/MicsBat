...
set LogFilePath=d:\Users\ahulme\temp\dpasscals%Tag%.txt
...
echo %PDFdir%\dlat.txt                >> tempFile.txt
echo %PDFdir%\dlong.txt               >> tempFile.txt
echo %PDFdir%\dgrnd.txt               >> tempFile.txt
echo %PDFdir%\dacode.txt              >> tempFile.txt
echo %PDFdir%\dahtv2.txt              >> tempFile.txt
echo %PDFdir%\dtxpwr.txt              >> tempFile.txt
echo %PDFdir%\dtxfreq.txt             >> tempFile.txt
echo %PDFdir%\dlata.txt               >> tempFile.txt
echo %PDFdir%\dlonga.txt              >> tempFile.txt
echo %PDFdir%\dgrnda.txt              >> tempFile.txt
echo %PDFdir%\dacodea.txt             >> tempFile.txt
echo %PDFdir%\dahta2.txt              >> tempFile.txt
echo %PDFdir%\drxfslav2.txt           >> tempFile.txt
echo %PDFdir%\dtxfslav2.txt           >> tempFile.txt
echo %PDFdir%\dtxpwrav2.txt           >> tempFile.txt
echo %PDFdir%\dtxfreqav2.txt          >> tempFile.txt
