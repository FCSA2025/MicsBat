...
/****** Object:  UserDefinedFunction [tsip].[distance_hs]    Script Date: 4/3/2019 7:11:38 AM ******/
SET ANSI_NULLS ON
GO
...
/*  Return the distance in Kilometres given lat/long inputs in hundredths of a second. */
/*	This is taken from the axDistan function, to give the same result. */
create function [tsip].[distance_hs](@lat1 as bigint, @lng1 as bigint, @lat2 as bigint, @lng2 as bigint)
returns float
begin
