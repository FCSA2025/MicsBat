...
GO
/*  Return the distance in Kilometres given lat/long inputs in degrees. */
/*	The algorithm follows that used in the MICS# AxDistan() function, to give the same result. */
ALTER function [hulme].[distance_deg](@lat1 as float, @lng1 as float, @lat2 as float, @lng2 as float)
returns float
begin
