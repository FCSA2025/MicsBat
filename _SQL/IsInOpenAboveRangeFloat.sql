USE [micsdev]
GO
/****** Object:  UserDefinedFunction [hulme].[isInOpenBelowRangeFloat]    Script Date: 6/9/2021 11:08:39 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE function [hulme].[isInOpenBelowRangeFloat](@lower as float, @upper as float, @testVal as float)
RETURNS BIT
BEGIN
